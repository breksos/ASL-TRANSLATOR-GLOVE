...
\usepackage[T1]{fontenc}      %% proper glyphs (incl. Turkish) with newtxtext
\usepackage[utf8]{inputenc}   %% UTF-8 source for Turkish characters in Ozet
\usepackage{booktabs}         %% nicer tables
\usepackage{multirow}
\usepackage{tikz}             %% native vector diagrams (architecture figure)
\usetikzlibrary{arrows.meta, positioning, fit, backgrounds}


% Important information
%% Make sure to enter all the info below
\title{ASL Glove: A Wearable American Sign Language Translator Using Inertial Sensing and On-Device Deep Learning}
\author{BERK HAKAN \"OGE \newline UTKU G\"OK\c{C}EK}
\faculty{Faculty of Engineering}
\department{Computer Engineering Department}
\supervisor{Prof. Dr. [Supervisor Name]} %% <-- replace with your supervisor
\theyear{2026}
...
\makejury{18/06/2026}{Prof. Dr. [Jury Member 1], [Jury Member 2]}
...
\input{./Body/Mainmatter/Chapter7}
\input{./Body/Mainmatter/Chapter8}
